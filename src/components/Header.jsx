...
function Header() {
  return (
    <div className='w-full h-24 flex items-center  absolute top-0 mt-4'>
        <div className="w-full max-w-screen-xl  h-fit flex justify-between items-center mx-auto">
            ...
            <div>
                <button className=' bg-[#31C3E0]   px-6 py-3 text-white text-base font-inter font-medium rounded-lg hover:bg-[#89DCED] hover:scale-105 transition-all duration-300 '>
